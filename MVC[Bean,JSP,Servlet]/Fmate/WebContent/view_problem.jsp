		 ...
		 <div class="row">
			 	<table class="table table-striped" style="text-align:center; border:1px solid #dddddd;">
			 		...
			 		<tbody>
			 			...
			 			<tr>
			 				<td>Answer</td>
			 				<td><input type="radio" name="chk_info" value="Model">Model
								<input type="radio" name="chk_info" value="Controller">Controller
								<input type="radio" name="chk_info" value="View">View
								<input type="radio" name="chk_info" value="None">None</td>
			 			</tr>
			 		</tbody>
			 	</table>
