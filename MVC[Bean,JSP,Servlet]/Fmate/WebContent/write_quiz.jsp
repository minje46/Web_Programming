...
<div class="topbar">
  <div class="container">
	...
	<div class="container">
		 <div class="row">
		 	<form method="post" action="write_quizAction.jsp">
			 	<table class="table table-striped" style="text-align:center; border:1px; solid #dddddd">
			 		<thead>
						<tr>
							<th colspan="1" style="background-color:#eeeeee; text-align: center;">Quiz</th>
						</tr>		 		
			 		</thead>
			 		
			 		<tbody>
			 			<tr>
			 				<td><input type="text" class="form-control" placeholder="Question" name="prTitle" maxlength="50"></td>
			 			</tr>
			 			<tr>	
			 				<td><textarea class="form-control" placeholder="Examples" name="prContent" maxlength="2048" style="height:350px"></textarea> </td>
			 			</tr>	
			 		</tbody>
			 	</table>
